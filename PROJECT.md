...
- `src/scene.js` · `src/physics.js` · `src/controllers.js` · `src/grab.js` · `src/locomotion.js` · `src/main.js` — subsystems (see CLAUDE.md → "Files").
...
4. **Spawning** new shapes with the grip button; limit/recycling.
